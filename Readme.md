...
# Parsing Script – Keller 23 SYEi - Rev. A

This **Parsing** script is designed for the **Keller 23 SYEi** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – Keller 23 SYEi Rev. A

Este script de **Parsing** está diseñado para el modelo **Keller 23 SYEi** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
